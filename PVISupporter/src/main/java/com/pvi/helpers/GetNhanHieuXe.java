...
public class GetNhanHieuXe extends AbstractProgressableAsyncTask<SoapObject, ArrayList<NhanHieuXeObject>> {
    private static final String TAG = GetNhanHieuXe.class.getName();
    private static final String WS_METHOD_NAME = "Dm_hieuxe_auto_new";

    public GetNhanHieuXe() {}
    ...
    @Override
    protected ArrayList<NhanHieuXeObject> performTaskInBackground(SoapObject parameter) throws Exception {
        ...
        ArrayList<NhanHieuXeObject> result = new ArrayList<>();
        try {
            ...
            if (!jsonValue.isNull("Consumers")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    Gson gson = new Gson();
                    NhanHieuXeObject resume = gson.fromJson(currentObject.toString(), NhanHieuXeObject.class);
                    result.add(resume);
                }
            }
