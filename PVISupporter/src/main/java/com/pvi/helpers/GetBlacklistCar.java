 ...
 */
public class GetBlacklistCar extends AbstractProgressableAsyncTask<SoapObject, List<PVICarObject>> {

    private static final String TAG = GetBlacklistCar.class.getName();
    private static final String WS_METHOD_NAME = "searchBlacklistCar";

    public GetBlacklistCar() {}
    ...
    @Override
    protected List<PVICarObject> performTaskInBackground(SoapObject parameter) throws Exception {
        ...
        List<PVICarObject> result = new ArrayList<PVICarObject>();
        try {
            ...
            if (!jsonValue.isNull("Consumers")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    Gson gson = new Gson();
                    PVICarObject resume = gson.fromJson(currentObject.toString(), PVICarObject.class);
                    result.add(resume);
                }
            }
