...
/**
 * Manages life cycle for asynchronous tasks
 * 
 */
public final class AsyncTaskManager implements IProgressTracker {
	 ...
	 *            task is completed.
	 */
	public <T, P> void executeTask(AbstractProgressableAsyncTask<P, T> task, P request, CharSequence progressLabel, OnAsyncTaskCompleteListener<T> onTaskCompletedListener) {
