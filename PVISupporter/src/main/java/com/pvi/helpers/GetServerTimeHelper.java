...
public class GetServerTimeHelper extends AbstractProgressableAsyncTask<SoapObject, String> {

	private static final String TAG = GetServerTimeHelper.class.getName();
	private static final String WS_METHOD_NAME = "GetTimeSRV";

	public GetServerTimeHelper() {}
